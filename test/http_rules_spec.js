...
describe('HttpRules', () => {
    ...
    it('parses empty rules', () => {
        expect(HttpRules.parse(undefined)).to.be.empty;
        expect(HttpRules.parse(null)).to.be.empty;
        expect(HttpRules.parse("")).to.be.empty;
        expect(HttpRules.parse(" ")).to.be.empty;
        expect(HttpRules.parse("\t")).to.be.empty;
    ...
    it('uses basic rules', () => {
        let rules = HttpRules.parse(HttpRules.basicRules);
        ...
        expect(rules.filter(r => 'remove' === r.verb).length).to.equal(2);
        expect(rules.filter(r => 'replace' === r.verb).length).to.equal(4);
