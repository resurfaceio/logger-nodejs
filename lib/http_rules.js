...
/request_body|request_param|response_body/ replace /[0-9\\.\\-\\/]{9,}/, /xyxy/\n`
    ...
    static parse(rules) {
        ...
        if ((typeof rules !== 'undefined') && (rules !== null)) {
            rules = rules.replace(/^\s*include basic\s*$/gm, this.basicRules);
    ...
    static parseRule(r) {
        ...
        if (m) return new HttpRule('replace', this._parseRegex(r, m[1]), this._parseRegex(r, m[2]),
