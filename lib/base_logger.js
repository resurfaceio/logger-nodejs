...
class BaseLogger {
    ...
    constructor(agent, options = {}) {
        ...
        if (typeof this._url === 'undefined' || ((this._url !== null) && !valid_url.is_uri(this._url))) {
            this._url = null;
            this._enabled = false;
        }
        ...
        if (!this.enabled) {
            ...
            return new Promise((resolve, reject) => {
                try {
                    ...
                    const request = lib.request(options, (response) => resolve(response.statusCode === 204));
                    // todo doesn't break tests if statusCode check fails
