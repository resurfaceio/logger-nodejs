...
class WriterWrapper {
    ...
    wrap(response, original_method) {
      return (chunk, encoding, callback) => {
        this.logged_bytes += (chunk instanceof Buffer || typeof chunk === 'string' || chunk instanceof String) ?
         Buffer.byteLength(chunk, encoding) : Buffer.byteLength(this.stringified_chunk =  JSON.stringify(chunk) || '');
        if (!this.overflowed) {
